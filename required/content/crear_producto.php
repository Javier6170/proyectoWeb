...
-->
<form method="post" action="<?php echo $BASE_ROOT_URL; ?>crear_producto.php">
<div class="mb-3">
  ...
  <div class="mb-3">
    <label for="descripcion" class="form-label">Textarea</label>
  ...
  <input type="submit" class="btn btn-primary" value="Crear Producto Nuevo">
</form>
